<?php session_start();
include "db/consultas_get_delete_peliculas.php";
...
<body>
	...
	<section>
		<article>
			<?php 
				$data = consultas_get_delete_peliculas($_GET["id"]); //esta funcion genera un array con los datos de la pelicula que busca segun su id
				...
				<form method="POST" action="db/delete_DB.php" name="eliminar_pellicula" id="eliminar_pellicula" enctype="multipart/form-data">
